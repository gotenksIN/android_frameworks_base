...
public class KeyHandler {
    ...
    private int mOneFingerSwipeDownKeyCode;
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == GESTURE_REQUEST) {
                final int scanCode = msg.arg1;

                if (DEBUG) {
                    Log.w(TAG, "EventHandler.handleMessage(): scanCode = " + scanCode);
                }
    ...
    private void getConfiguration() {
        ...
        mOneFingerSwipeDownKeyCode = resources.getInteger(R.integer.config_oneFingerSwipeDownKeyCode);
        ...
        mGestures.put(mOneFingerSwipeDownKeyCode, mOneFingerSwipeDownGesture);
    ...
    private Message getMessageForKeyEvent(int scanCode) {
        return mHandler.obtainMessage(GESTURE_REQUEST, scanCode, 0);
    }
