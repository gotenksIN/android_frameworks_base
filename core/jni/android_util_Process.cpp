...
// QTI_BEGIN: 2018-04-19: Core: Ensure cgroup.procs in the same cgroup
#include <cutils/properties.h>
// QTI_END: 2018-04-19: Core: Ensure cgroup.procs in the same cgroup
...
// QTI_BEGIN: 2018-08-21: Core: Process: Use audio-app cpuset if available
...
// QTI_END: 2018-08-21: Core: Process: Use audio-app cpuset if available
}
...
// QTI_BEGIN: 2018-04-19: Core: Ensure cgroup.procs in the same cgroup
{
    int fd;
// QTI_END: 2018-04-19: Core: Ensure cgroup.procs in the same cgroup
// QTI_BEGIN: 2021-05-20: Core: add support read cgroup.procs from cgroup V2 path
    char pathV1[255], pathV2[255];
    static bool isCgroupV2 = false;
// QTI_END: 2021-05-20: Core: add support read cgroup.procs from cgroup V2 path
// QTI_BEGIN: 2018-04-19: Core: Ensure cgroup.procs in the same cgroup
