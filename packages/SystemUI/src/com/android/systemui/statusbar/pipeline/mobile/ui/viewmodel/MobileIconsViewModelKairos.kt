    ...
    private fun trackedInteractor(subId: Int): MobileIconInteractorKairos =
        object : MobileIconInteractorKairos {
            ...
            override val isRoamingForceHidden: State<Boolean> =
                latest(false) { isRoamingForceHidden }
            ...
            override val volteId: State<Int> = latest(0) { volteId }
            override val showSignalStrengthIcon: State<Boolean> = latest(true) { showSignalStrengthIcon }
        }
