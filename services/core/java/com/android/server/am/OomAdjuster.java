...
// QTI_BEGIN: 2020-06-16: Core: Send top-app's render thread tid to perf HAL
    //Per Task Boost of top-app renderThread
    public static BoostFramework mPerfBoost = new BoostFramework();
    public static int mPerfHandle = -1;
// QTI_END: 2020-06-16: Core: Send top-app's render thread tid to perf HAL
...
// QTI_BEGIN: 2020-06-16: Core: Send top-app's render thread tid to perf HAL
                        if (mPerfHandle >= 0) {
// QTI_END: 2020-06-16: Core: Send top-app's render thread tid to perf HAL
// QTI_BEGIN: 2025-02-20: Core: Perf: Fix unexpected perf hint handle released from OomAdjust
                            mPerfBoost.perfLockReleaseHandler(mPerfHandle);
// QTI_END: 2025-02-20: Core: Perf: Fix unexpected perf hint handle released from OomAdjust
// QTI_BEGIN: 2020-06-16: Core: Send top-app's render thread tid to perf HAL
                            mPerfHandle = -1;
                        }
